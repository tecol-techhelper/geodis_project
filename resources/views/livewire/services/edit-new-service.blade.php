...
<div>
    ...
    <form wire:submit.prevent="" enctype="multipart/form-data"
        class="px-6 py-6 space-y-6 my-4 border-2 border-gray-100 shadow-xl rounded-2xl">
        ...
        <div class="flex justify-end space-x-4 mt-6">
            <x-danger-button type="button" wire:click="reject"
                class="px-4 py-2 border rounded">Rechazar</x-danger-button>
            <x-success-button type="submit" class="px-4 py-2 border rounded">Aceptar</x-success-button>
        </div>
    </form>
</div>
