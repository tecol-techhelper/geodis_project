...
<div>
    <x-primary-button x-on:click="modalIsOpen = true;setTimeout(() => $el.blur(), 100)" type="button" class="space-x-1">
    ...
    <div x-cloak x-show="modalIsOpen" x-transition.opacity.duration.200ms x-trap.inert.noscroll="modalIsOpen"
        ...
        <div x-show="modalIsOpen"
            ...
            <div
                ...
                <x-primary-button wire:click.prevent="uploadFiles" x-on:click="setTimeout(() => $el.blur(), 100)"
                    wire:click="uploadFiles" type="submit" class="space-x-1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <x-success-button x-on:click="setTimeout(() => $el.blur(), 100)" wire:click.prevent="saveFiles"
                    type="submit" class="space-x-1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
