...
<nav class="bg-white px-6 py-3 flex items-center justify-between h-16 shadow-md">
    ...
    <div class="flex items-center space-x-4">
        ...
        <a href="<?php echo e(route('dashboard')); ?>" class="block visible md:hidden">
        ...
        <div class="flex items-center space-x-2">
            ...
            <span><?php echo e(ucfirst(\Carbon\Carbon::now()->locale('es')->translatedFormat('F d, Y'))); ?></span>
        </div>
...
[$__name, $__params] = $__split('services.notifications-bell', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-237817467-0', $__slots ?? [], get_defined_vars());
...
?>
        ...
        <div class="relative" x-data="{ userMenuOpen: false }">
            <button @click="userMenuOpen = !userMenuOpen" class="flex items-center px-3 md:px-6 focus:outline-none">
                <img src="<?php echo e(Auth::user()->user_icon ? Storage::url(Auth::user()->user_icon) : asset('images/logos/logo_top.png')); ?>"
                    alt="Icono Usuario"
            ...
            <div x-show="userMenuOpen" @click.outside="userMenuOpen = false"
                ...
                <div class="flex items-center border-b border-outline block px-4 py-2 text-gray-700 hover:bg-gray-300">
                    ...
                    <div class="px-2">
                        <span><?php echo e(ucwords(Auth::user()->first_name . ' ' . Auth::user()->last_name)); ?></span>
                        <p class="text-xs"><?php echo e(Auth::user()->roles->first()?->rol_name); ?></p>
                    </div>
                </div>
...
</nav><?php /**PATH C:\Users\ASUS\Documents\Proyectos\geodis_project\resources\views\livewire/layout/navigation.blade.php ENDPATH**/ ?>